...
export default function ArtisansDetails({ id, closeDetails }: { id: number, closeDetails: () => void; }) {
    ...
    async function handleFetchArtisans() {
        ...
        try {
            ...
            const res = await fetch(`${import.meta.env.VITE_BASE_URL}/v1/admin/artisans/${id}`, {
            	method: "GET",
            	headers,
            });
        ...
        {(!loading.modal && artisansData?.id) && (
            <div className="details--container flex-col-3">
                ...
                <div className="modal--actions">
                    <button className="modal--btn black-outline" onClick={() => navigate(`/dashboard/artisans/${id}/edit`)}>Edit</button>
